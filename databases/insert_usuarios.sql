...
VALUES 
('Sura', 'Colpatria', 'Protección', 'Comfama', 27),
('Sanitas', 'Sura', 'Colfondos', 'Cafam', 28),
('Nueva EPS', 'Bolívar', 'Porvenir', 'Compensar', 29),
('Compensar', 'Bolívar', 'Porvenir', 'Colsubsidio', 30),
('Coomeva', 'Positiva', 'Old Mutual', 'Cajasan', 31),
('Famisanar', 'Liberty', 'Horizonte', 'Comfama', 32),
('Aliansalud', 'Sura', 'Colpatria', 'Compensar', 33),
('Salud Total', 'Bolívar', 'Skandia', 'Cafam', 34),
('Sanitas', 'Axa Colpatria', 'Porvenir', 'Comfandi', 35),
('Nueva EPS', 'Mapfre', 'Colfondos', 'Cajacopi', 36),
('Coomeva', 'Bolívar', 'Old Mutual', 'Comfenalco', 37),
('Famisanar', 'Liberty', 'Protección', 'Colsubsidio', 38),
('Aliansalud', 'Sura', 'Colpatria', 'Compensar', 39),
('Salud Total', 'Bolívar', 'Skandia', 'Cafam', 40),
('Sanitas', 'Axa Colpatria', 'Porvenir', 'Comfandi', 41),
('Nueva EPS', 'Mapfre', 'Colfondos', 'Cajacopi', 42),
('Coomeva', 'Bolívar', 'Old Mutual', 'Comfenalco', 43),
('Famisanar', 'Liberty', 'Protección', 'Colsubsidio', 44),
('Aliansalud', 'Sura', 'Colpatria', 'Compensar', 45),
('Salud Total', 'Bolívar', 'Skandia', 'Cafam', 46);
