...
export async function validacionesSwitch(
  ...
  try {
    ...
    console.log("DATOS RECIBIDOS EN SWITCH: ",
      id_liquidacion,
      id_historial,
      proceso_1,
      id_user_session
      ...
      switch (proceso_1.parametros.tipo_incapacidad) {
        ...
        case "ARL":
          ...
          if (proceso_1.liq_prorroga === 'NO') {
            ...
            console.log("ARL SIN PRORROGA INICIO")

            /* FUNCION PARA PRRROGA NO */
            const arlProrrogaNO_ = await arlProrrogaNO(id_liquidacion, id_historial, proceso_1, id_user_session)


            /* SI EL RESULTADO ES TRUE, ACTUALIZAR DOWNLOAD A  1 */
            if (arlProrrogaNO_.success) {
              ...
              return {
                success: true,
                message: arlProrrogaNO_.message
              };
            }
          ...
          if (proceso_1.liq_prorroga === 'SI') {
            ...
            console.log("ARL CON PRORROGA INICIO")
